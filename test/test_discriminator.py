...
negative_file = 'save/negetive_file.txt'
    ...
    with open(input_file)as fin:
        for line in fin:
            ...
            for i in range(2, SEQ_LENGTH+1):
                data = parse_line[:i] + [5000] * (SEQ_LENGTH-i)
...
if __name__ == '__main__':
    ...
    main()
    # split_sentence('save/real_data.txt', 'save/positive_file.txt')
    # split_sentence('save/generator_sample.txt', 'save/negetive_file.txt')
